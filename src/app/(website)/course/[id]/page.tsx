...
import { ChevronDown, Check, BookOpen, Zap, FileCheck, Award } from "lucide-react"
...
const courseData = {
  ...
  hero: {
    ...
    image: "https://cdn.packtpub.com/article-hub/articles/06c5f82691f91981124df9762de95473.jpg",
  },
    ...
    highlights: [
      {
        ...
        description: "Access to vulnerable VMs and realistic network environments for hands-on practice without risk",
      },
      {
        title: "Industry Experts",
        description: "Learn from certified security professionals with 15+ years of penetration testing experience",
      },
      {
        title: "Project-Based Learning",
        description: "Complete 5 capstone projects that showcase real penetration testing engagements",
      },
      {
        title: "Career Support",
        description: "Resume review, interview prep, and job placement assistance from our career team",
      },
      {
        title: "Certification Ready",
        description: "Prepare for CEH, OSCP, and other industry-recognized certifications",
      },
      {
        title: "Community Access",
        description: "Join 50,000+ students in our exclusive Discord community and networking events",
      },
    ],
    ...
    certification: [
      {
        ...
        description: "Finish all 5 modules with at least 80% quiz scores to be eligible",
      },
      {
        step: "2. Capstone Project",
        description: "Submit a complete penetration test report on a simulated engagement",
      },
      {
        step: "3. Certification Exam",
        description: "Pass our comprehensive 3-hour practical exam (70% passing score required)",
      },
      {
        step: "4. Receive Certificate",
        description: "Get your digital certificate recognized by the industry and employers",
      },
    ],
  },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="mb-6">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold mb-4 text-white leading-tight">{courseData.title}</h1>
              <p className="text-xl text-gray-400 mb-2">{courseData.tagline}</p>
            </div>

            <p className="text-gray-300 text-lg mb-8 leading-relaxed">{courseData.description}</p>

            {/* Stats */}
            <div className="grid grid-cols-3 gap-6 mb-10 py-6 border-y border-gray-800">
              <div>
                <p className="text-gray-400 text-sm mb-1">Duration</p>
                <p className="text-2xl font-bold text-white">{courseData.duration}</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-1">Students</p>
                <p className="text-2xl font-bold text-white">{courseData.students}</p>
              </div>
              <div>
                <p className="text-gray-400 text-sm mb-1">Rating</p>
                <p className="text-2xl font-bold text-red-500">★ {courseData.rating}</p>
              </div>
            </div>
          ...
          {activeTab === "syllabus" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {courseData.tabs.syllabus.map((module, idx) => (
                ...
                >
                  <h3 className="text-xl font-bold text-red-500 mb-4">{module.section}</h3>
              ...
              <div className="space-y-6">
                {courseData.tabs.certification.map((cert, idx) => (
                  <div key={idx} className="flex gap-6">
                    ...
                    <div className="pb-6">
                      <h3 className="text-xl font-bold text-white mb-2">{cert.step}</h3>
